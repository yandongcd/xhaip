"""肾内科智能体 ? KnowledgeAgent-powered clinical reasoning.

Agent: nephrology | Department: 肾内科
Guidelines: 'KDIGO 2024 CKD评估与管理指南'
"""
...
_guidelines = ['KDIGO 2024 CKD评估与管理指南']
