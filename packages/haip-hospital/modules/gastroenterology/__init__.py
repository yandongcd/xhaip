"""消化内科智能体 ? KnowledgeAgent-powered clinical reasoning.

Agent: gastroenterology | Department: 消化内科
Guidelines: '中华消化杂志 消化内镜诊疗指南 (2022)'
"""
...
_guidelines = ['中华消化杂志 消化内镜诊疗指南 (2022)']
...
def bp_reception(**kwargs) -> dict:
    ...
    return _agent.clinical_result(
        summary=f"消化内科智能体 ? Bp Reception??",
        patient=patient,
        guidelines=guides[:3],
        alerts=alerts,
    )
...
def bp_diagnosis(**kwargs) -> dict:
    ...
    return _agent.clinical_result(
        summary=f"消化内科智能体 ? Bp Diagnosis??",
        patient=patient,
        guidelines=guides[:3],
        alerts=alerts,
    )
...
def bp_treatment(**kwargs) -> dict:
    ...
    return _agent.clinical_result(
        summary=f"消化内科智能体 ? Bp Treatment??",
        patient=patient,
        guidelines=guides[:3],
        alerts=alerts,
    )
