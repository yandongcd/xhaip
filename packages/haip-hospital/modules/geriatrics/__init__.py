...
def bp_reception(**kwargs) -> dict:
    ...
    return _agent.clinical_result(
        summary="老年病科—老年综合评估完成 (stage S1)",
        patient=p,
        guidelines=guides,
        rules=rules,
...
def bp_exam(**kwargs) -> dict:
    ...
    rules = _agent.search_rules("老年病科")
    return _agent.clinical_result(
        summary="老年病科—老年专项检查完成 (stage S2)",
        patient=p,
        guidelines=guides,
        rules=rules,
        alerts=vitals.get("alerts", []),
...
def bp_diagnosis(**kwargs) -> dict:
    ...
    rules = _agent.search_rules("老年病科")
    return _agent.clinical_result(
        summary="老年病科—老年综合征诊断完成 (stage S3)",
        patient=p,
        guidelines=guides,
        rules=rules,
        alerts=vitals.get("alerts", []),
