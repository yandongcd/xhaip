"""风湿免疫科智能体 ? KnowledgeAgent-powered clinical reasoning.

Agent: rheumatology | Department: 风湿免疫科
Guidelines: 'EULAR 2023 类风湿关节炎管理指南'
"""
...
_guidelines = ['EULAR 2023 类风湿关节炎管理指南']
...
def bp_reception(**kwargs) -> dict:
    ...
    return _agent.clinical_result(
        summary=f"风湿免疫科智能体 ? Bp Reception??",
        patient=patient,
        guidelines=guides[:3],
        alerts=alerts,
    )
...
def bp_diagnosis(**kwargs) -> dict:
    ...
    return _agent.clinical_result(
        summary=f"风湿免疫科智能体 ? Bp Diagnosis??",
        patient=patient,
        guidelines=guides[:3],
        alerts=alerts,
    )
...
def bp_treatment(**kwargs) -> dict:
    ...
    return _agent.clinical_result(
        summary=f"风湿免疫科智能体 ? Bp Treatment??",
        patient=patient,
        guidelines=guides[:3],
        alerts=alerts,
    )
...
def bp_followup(**kwargs) -> dict:
    ...
    return _agent.clinical_result(
        summary=f"风湿免疫科智能体 ? Bp Followup??",
        patient=patient,
        guidelines=guides[:3],
        alerts=alerts,
    )
