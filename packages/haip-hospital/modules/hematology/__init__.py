"""血液内科智能体 ? KnowledgeAgent-powered clinical reasoning.

Agent: hematology | Department: 血液内科
Guidelines: '中华血液学杂志 血液病诊疗指南 (2022)'
"""
...
_guidelines = ['中华血液学杂志 血液病诊疗指南 (2022)']
...
def bp_reception(**kwargs) -> dict:
    ...
    return _agent.clinical_result(
        summary=f"血液内科智能体 ? Bp Reception??",
        patient=patient,
        guidelines=guides[:3],
        alerts=alerts,
    )
...
def bp_diagnosis(**kwargs) -> dict:
    ...
    return _agent.clinical_result(
        summary=f"血液内科智能体 ? Bp Diagnosis??",
        patient=patient,
        guidelines=guides[:3],
        alerts=alerts,
    )
...
def bp_treatment(**kwargs) -> dict:
    ...
    return _agent.clinical_result(
        summary=f"血液内科智能体 ? Bp Treatment??",
        patient=patient,
        guidelines=guides[:3],
        alerts=alerts,
    )
