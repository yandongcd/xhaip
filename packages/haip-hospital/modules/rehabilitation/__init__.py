"""康复医学科智能体 ? KnowledgeAgent-powered clinical reasoning.

Agent: rehabilitation | Department: 康复医学科
Guidelines: '中华康复医学杂志 康复诊疗指南 (2022)'
"""
...
_guidelines = ['中华康复医学杂志 康复诊疗指南 (2022)']
...
def bp_reception(**kwargs) -> dict:
    ...
    return _agent.clinical_result(
        summary=f"康复医学科智能体 ? Bp Reception??",
        patient=patient,
        guidelines=guides[:3],
        alerts=alerts,
    )
...
def bp_diagnosis(**kwargs) -> dict:
    ...
    return _agent.clinical_result(
        summary=f"康复医学科智能体 ? Bp Diagnosis??",
        patient=patient,
        guidelines=guides[:3],
        alerts=alerts,
    )
...
def bp_treatment(**kwargs) -> dict:
    ...
    return _agent.clinical_result(
        summary=f"康复医学科智能体 ? Bp Treatment??",
        patient=patient,
        guidelines=guides[:3],
        alerts=alerts,
    )
...
def bp_followup(**kwargs) -> dict:
    ...
    return _agent.clinical_result(
        summary=f"康复医学科智能体 ? Bp Followup??",
        patient=patient,
        guidelines=guides[:3],
        alerts=alerts,
    )
