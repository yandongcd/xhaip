"""肿瘤科智能体 ? KnowledgeAgent-powered clinical reasoning.

Agent: oncology | Department: 肿瘤科
Guidelines: '中国临床肿瘤学会 CSCO 指南 (2024)'
"""
...
_guidelines = ['中国临床肿瘤学会 CSCO 指南 (2024)']
